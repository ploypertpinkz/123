...
audio1.setAttribute('src', 'audio/correct.mp3');

var audio2 = document.createElement('audio');
audio2.setAttribute('src', 'audio/Error.mp3');
...
var choice9 = ["2.1", "2.7", "2.3", "2.8"];
var choice10 = ["3.3", "3.4", "3.5", "3.6"];

var Ans1 = ["2.0","0.9","3","5.4","1.8","11.2","3.9","2.7","2.8","3.6"]
...
function checkAns(round, valueBtn) {
    ...
    for (i = 0; i < Ans1.length; i++) {
        if (i+1 == round) {
            ...
            document.getElementById("roundBoard").innerHTML = "EasyRound : " + (round + 1) + "/10";
        }
    }
